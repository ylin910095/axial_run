...
## Quark controls
basePropList = (0, 1, 0, 1) # only count those that are solved
quarkTypeList = ("identity", "identity", "gauss", "gauss")
quarkBaseList = (None, None, None, None)
quarkSmearParam = (None, None, gparam_list[0], gparam_list[0])
quarkLabelOverride = (None, None, None, None) # if not None, override the default labeling
quarkSinkTypeList = ("point", "point", "point", "point",)

## parameters to make insertions with - NOT used for 2pt
